  ...
  return (
    <>
      ...
      <section className="bg-white text-gray-900 py-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          <div className="relative inline-block mb-6">
            <h1 className="text-6xl font-extrabold text-black-800 tracking-tight drop-shadow-[2px_2px_0_rgba(0,0,0,0.15)]">INVESTMENTS</h1>
          </div>
      ...
      <section className="bg-white text-gray-900 py-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          <div className="relative inline-block mb-6">
            <h1 className="text-6xl font-extrabold text-black-800 tracking-tight drop-shadow-[2px_2px_0_rgba(0,0,0,0.15)]">RENOVATIONS</h1>
          </div>
      ...
      <section className="bg-white text-gray-900 py-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          <div className="relative inline-block mb-6">
            <h1 className="text-6xl font-extrabold text-black-800 tracking-tight drop-shadow-[2px_2px_0_rgba(0,0,0,0.15)]">PROPERTY MANAGEMENT</h1>
          </div>
